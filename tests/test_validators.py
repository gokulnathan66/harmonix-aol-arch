...
class TestManifestValidator:
    ...
    def test_valid_manifest(self):
        ...
        manifest = {
            ...
            "spec": {
                "endpoints": {"grpc": "50051", "health": "50200", "metrics": "8080"},
    ...
    def test_missing_required_field(self):
        ...
        manifest = {
            ...
            "apiVersion": "v1",
            # Missing 'metadata'
            "spec": {"endpoints": {"grpc": "50051", "health": "50200"}},
        }
    ...
    def test_invalid_port_range(self):
        ...
        manifest = {
            ...
            "apiVersion": "v1",
            "metadata": {"name": "test-service", "version": "1.0.0"},
            "spec": {"endpoints": {"grpc": "99999", "health": "50200"}},  # Invalid port
        }
...
class TestConfigValidator:
    ...
    def test_valid_config(self):
        ...
        config = {
            "service": {"name": "test-service", "kind": "AOLService"},
            "dataClient": {"enabled": True, "aolCoreEndpoint": "aol-core:50051"},
            "resilience": {"circuitBreaker": {"enabled": True, "failureThreshold": 5}},
        }
