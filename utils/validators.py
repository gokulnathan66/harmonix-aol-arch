...
MANIFEST_SCHEMA = {
    ...
    "apiVersion": {"required": True, "type": str, "values": ["v1"]},
    "metadata": {
        "required": True,
        "type": dict,
        "schema": {
    ...
    "spec": {
        ...
        "schema": {
            ...
            "configSchema": {"required": False, "type": list},
            "communication": {"required": False, "type": dict},
            "integrations": {"required": False, "type": dict},
            "resilience": {"required": False, "type": dict},
            "health": {"required": False, "type": dict},
            "monitoring": {"required": False, "type": dict},
...
class ManifestValidator:
    ...
    def validate(self, manifest: Dict[str, Any]) -> ValidationResult:
        ...
        self._validate_schema(
            data=manifest, schema=MANIFEST_SCHEMA, path="", issues=issues
        )
