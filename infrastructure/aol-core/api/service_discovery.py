...
def setup_service_discovery_api(app: web.Application, consul_registry: ConsulServiceRegistry):
    ...
    async def get_service_health(request):
        ...
        try:
            ...
            instances = consul_registry.discover_service(service_name, healthy_only=False)
